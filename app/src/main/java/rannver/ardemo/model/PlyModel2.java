...
public class PlyModel2 {
    ...
    public PlyModel2(InputStream inputStream,Context context) throws IOException {
    ...
    public void init(float boundSize) {
        ...
        glProgram = initialUtil.compileProgram(R.raw.point_cloud_vertex, R.raw.single_color_fragment,
